...
from hw.packet import packet, Command_type

class command_center(object):

    def __init__(self, appID : int, node_id : int, packet_handler, debugger : debugger) -> None:
        super().__init__()
        ...
        self.interval_queue_update = 1000*10
